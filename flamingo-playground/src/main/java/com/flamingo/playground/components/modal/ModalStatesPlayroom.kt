package com.flamingo.playground.components.modal
...
@StatesPlayroomDemo
class ModalStatesPlayroom : PreferenceFragmentCompat() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        setPreferencesFromResource(R.xml.states_playroom_modal, rootKey)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        configurePreference<EditTextPreference>("title") {
            ...
            initPref(savedInstanceState, defVal = "Modal")
        }

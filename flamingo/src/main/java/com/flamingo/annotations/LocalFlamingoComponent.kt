 ...
 * [local flamingo components](https://confluence.companyname.ru/x/M5moXQE).
 *
 * Local flamingo components are meant to be created and maintained by feature-developers in their
 * respective feature-modules. Some, however, can be extracted into common gradle modules and can be
 ...
 * @param figma url. MUST start with `https://www.f.com/` or `https://f.com/`. CAN be empty.

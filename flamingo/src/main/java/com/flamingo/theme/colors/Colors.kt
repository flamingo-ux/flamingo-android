...
internal val lightColors = with(Flamingo.palette) {
    FlamingoColors(
        ...
        rating = yellow300,
        error = red700,
        separator = blue850.copy(alpha = .08f),
        outline = blue850.copy(alpha = .16f),
        outlineDark = blue850.copy(alpha = .32f),
        background = white,
        backgroundSecondary = coolGrey100,
        backgroundTertiary = coolGrey150,
        backgroundTextField = coolGrey500.copy(alpha = .08f),
        backgroundQuaternary = coolGrey800.copy(alpha = .08f),
        ...
        global = GlobalColors(
            ...
            dark = GlobalColors.GlobalColorsVersion(
                ...
                textSecondary = black.copy(alpha = .60f),
                textTertiary = black.copy(alpha = .38f),
                backgroundPrimary = coolGrey1000,
                backgroundSecondary = coolGrey900,
                backgroundTertiary = coolGrey850,
            ),
        ),
